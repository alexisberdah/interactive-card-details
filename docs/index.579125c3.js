...
function resetErrors() {
    ...
    for(let i = 0; i < activeElements.length; i++)activeElements[i].classList.remove("active");
    var errors = document.querySelectorAll(".errorInput");
    for(let i = 0; i < errors.length; i++)errors[i].classList.remove("errorInput");
}
...
function handleInput(event) {
    ...
    switch(type){
        case "name":
            ...
            } else document.getElementById("name").innerHTML = value.toUpperCase();
            if (value == "") document.getElementById("name").innerHTML = "JANE APPLESEED";
            break;
        case "number":
            ...
            document.getElementById("number").innerHTML = formattedNumber();
            if (value == "") document.getElementById("number").innerHTML = "0000 0000 0000 0000";
            break;
        case "month":
            str = "00";
            if (value.length > 2) {
